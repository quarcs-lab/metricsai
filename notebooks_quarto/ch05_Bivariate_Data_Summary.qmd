...
# R-squared = (Explained SS) / (Total SS) measures the proportion explained
```
...
# 1. TOP SECTION - Model Summary: Dep. Variable, No. Observations, R-squared, F-statistic
# 2. MIDDLE SECTION - Coefficients Table: coef, std err, t, P>|t|, 95% CI
# 3. BOTTOM SECTION - Diagnostic Tests: Omnibus, Durbin-Watson, Jarque-Bera, Cond. No.
```
