...
# Economic interpretation
print(f"\nFor every additional square foot, price increases by ~${slope:,.2f}")
print(f"The model explains {r_squared*100:.2f}% of the variation in house prices")
```
...
# The purple line is the "line of best fit"
