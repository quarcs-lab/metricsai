...
model_ols = ols('lnwage ~ educ', data=df).fit(cov_type='HC1')
print(f"OLS estimate: {model_ols.params['educ']:.4f}")
print(f"Interpretation: Each year of education is associated with {model_ols.params['educ']*100:.1f}% higher wages")
```
