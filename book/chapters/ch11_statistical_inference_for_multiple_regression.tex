...
\textbf{Table 11.2: Multiple Regression Results}
...
\textbf{Context:} This section constructs 95\% confidence intervals for each regression coefficient, providing ranges of plausible values for the true parameters.
