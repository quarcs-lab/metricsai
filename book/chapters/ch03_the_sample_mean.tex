...
\label{fig:ch03:single-coin-toss-sample}
\end{figure}
...
\begin{table}[h]
\centering
\caption{Summary Statistics for 400 Sample Means from Coin Toss Simulations}
\label{tab:ch03:coin-toss-sample-means}
\begin{tabular}{lrrr}
\toprule
...
\label{fig:ch03:distribution-sample-means-400}
\end{figure}
...
\begin{table}[h]
\centering
\caption{Summary Statistics for 100 Sample Means from 1880 U.S. Census Data}
\label{tab:ch03:census-sample-means}
\begin{tabular}{lrrr}
\toprule
...
\label{fig:ch03:census-age-means}
\end{figure}
...
\label{fig:ch03:simulated-sample-means}
\end{figure}
