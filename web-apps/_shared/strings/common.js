/* Shared cross-chapter UI chrome — registered into window.I18N by i18n-runtime.js.
 * Referenced by: web-apps/ch01..ch17/dashboard.html (verified present in all 17).
 * 5 keys total: 3 common.* + 2 theme.* (theme toggle is general UI chrome).
